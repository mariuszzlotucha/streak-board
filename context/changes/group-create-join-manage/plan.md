...
- [x] 3.4 Smoke passes including the member view, rename and leave steps: `npm run smoke`

#### Manual

- [x] 3.5 The invite link copies to the clipboard in the browser and the button confirms it
- [x] 3.6 The member list shows emails with Owner and You markers
- [x] 3.7 The leave dialog keeps the group on Cancel/Esc and leaves it on Confirm
- [x] 3.8 The owner sees rename and no leave button; renaming to an empty or 81-character name shows an error
- [x] 3.9 The group view is usable at 375 px width
